...
Net::Net(vector<int> inputsPerLayer, vector<int> neuronsPerLayer, double learnRate)
{
...
// forward pass
vector<double> Net::forwardPass(vector<double> inputs)
{
...
void Net::backPass(vector<double> gradNext)
{
    // for each layer
